...
- [#38](https://github.com/christianmeude/inea-scents-client/issues/38) — Use Supabase `pg_cron` + `pg_net` to ping a secured Laravel API endpoint every 15 minutes, bypassing Render's lack of a free-tier cron scheduler while keeping business logic in Laravel.
