...
class _AvailabilityApiClient implements AvailabilityApiClient {
  ...
  @override
  Future<GetApiPingResponse> getApiPing() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetApiPingResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/ping',
    ...
    late GetApiPingResponse _value;
    try {
      _value = GetApiPingResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
